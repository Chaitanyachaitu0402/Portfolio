...
import chaitu from "../assets/chaitu1.jpg";
import chaitu2 from "../assets/chaitu2.jpg";
import chaitu3 from "../assets/chaitu3.jpg";
          ...
          <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
            <div className="relative bg-n-8 rounded-[1rem]">
              ...
              <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden  ">
                <img
                  src={chaitu3}
                  className="w-full  md:scale-[1] -translate-x-1 md:-translate-y-[22%] lg:-translate-y-[19%]"
                  alt="AI"
                />
