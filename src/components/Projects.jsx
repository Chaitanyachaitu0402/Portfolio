              ...
              {benefits.map((item, index) => (
                <SwiperSlide key={item.id}>
                  <motion.div
                    ...
                    className="flex flex-col mb-15 group  relative  bg-no-repeat  md:max-w-[24rem] shadow-lg xl:w-[22rem] p-0.5 bg-[length:100%_100%] xl:rounded-tl-[30px] rounded-tl-[35px] rounded-br-[65px] xl:rounded-br-[70px] mr-2 backdrop-blur-[3px] border-[2px] border-n-4"
